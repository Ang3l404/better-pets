...
// var names_1 = require("../common/names");
...
//     switch (theme) {
//         case types_1.Theme.forest:
//             switch (size) {
//                 case types_1.PetSize.small:
//                     return 30;
//                 case types_1.PetSize.medium:
//                     return 40;
//                 case types_1.PetSize.large:
//                     return 65;
//                 case types_1.PetSize.nano:
//                 default:
//                     return 23;
//             }
//         case types_1.Theme.castle:
//             switch (size) {
//                 case types_1.PetSize.small:
//                     return 60;
//                 case types_1.PetSize.medium:
...
//     exports.allPets.pets.forEach(function (element) {
...
//         updates.forEach(function (message) {
//             stateApi === null || stateApi === void 0 ? void 0 : stateApi.postMessage({
//                 text: message,
//                 command: 'info',
//             });
//         });
...
//     exports.allPets.pets.forEach(function (petItem) {
//         var _a, _b, _c;
//         (_a = state.petStates) === null || _a === void 0 ? void 0 : _a.push({
//             petName: petItem.pet.name,
//             petColor: petItem.color,
//             petType: petItem.type,
//             petState: petItem.pet.getState(),
//             petFriend: (_c = (_b = petItem.pet.friend) === null || _b === void 0 ? void 0 : _b.name) !== null && _c !== void 0 ? _c : undefined,
//             elLeft: petItem.el.style.left,
//             elBottom: petItem.el.style.bottom,
//         });
//     });
//     state.petCounter = petCounter;
//     stateApi === null || stateApi === void 0 ? void 0 : stateApi.setState(state);
// }
...
//         stateApi = acquireVsCodeApi();
//     }
//     var state = stateApi === null || stateApi === void 0 ? void 0 : stateApi.getState();
//     if (!state) {
//         petCounter = 1;
//     }
//     else {
...
//         }
//         else {
//             petCounter = (_a = state.petCounter) !== null && _a !== void 0 ? _a : 1;
//         }
//     }
//     var recoveryMap = new Map();
//     (_b = state === null || state === void 0 ? void 0 : state.petStates) === null || _b === void 0 ? void 0 : _b.forEach(function (p) {
...
//         }
//         try {
//             var newPet = addPetToPanel((_a = p.petType) !== null && _a !== void 0 ? _a : types_1.PetType.cat, basePetUri, (_b = p.petColor) !== null && _b !== void 0 ? _b : types_1.PetColor.brown, petSize, parseInt((_c = p.elLeft) !== null && _c !== void 0 ? _c : '0'), parseInt((_d = p.elBottom) !== null && _d !== void 0 ? _d : '0'), floor, (_e = p.petName) !== null && _e !== void 0 ? _e : (0, names_1.randomName)((_f = p.petType) !== null && _f !== void 0 ? _f : types_1.PetType.cat), stateApi);
...
//         }
//     });
//     recoveryMap.forEach(function (state, pet) {
...
//     var ballRadius = calculateBallRadius(petSize);
//     var floor = 0;
//     if (!stateApi) {
//         stateApi = acquireVsCodeApi();
//     }
...
//                 break;
//         }
//         document.body.style.backgroundImage = "url('".concat(basePetUri, "/backgrounds/").concat(theme, "/background-").concat(_themeKind, "-").concat(petSize, ".png')");
//         // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
//         foregroundEl.style.backgroundImage = "url('".concat(basePetUri, "/backgrounds/").concat(theme, "/foreground-").concat(_themeKind, "-").concat(petSize, ".png')");
...
//     var gravity = 0.6, damping = 0.9, traction = 0.8, interval = 1000 / 24; // msec for single frame
//     var then = 0; // last draw
//     var ballState;
//     function resetBall() {
//         if (ballState) {
...
//             exports.allPets.pets.forEach(function (petEl) {
...
//                 break;
//             case 'spawn-pet':
//                 exports.allPets.push(addPetToPanel(message.type, basePetUri, message.color, petSize, randomStartPosition(), floor, floor, (_a = message.name) !== null && _a !== void 0 ? _a : (0, names_1.randomName)(message.type), stateApi));
//                 saveState(stateApi);
//                 break;
//             case 'list-pets':
...
//                     command: 'list-pets',
//                     text: pets
//                         .map(function (pet) { return "".concat(pet.type, ",").concat(pet.pet.name, ",").concat(pet.color); })
//                         .join('\n'),
//                 });
//                 break;
//             case 'roll-call':
...
//                     stateApi === null || stateApi === void 0 ? void 0 : stateApi.postMessage({
//                         command: 'info',
//                         text: "".concat(pet.pet.emoji, " ").concat(pet.pet.name, " (").concat(pet.color, " ").concat(pet.type, "): ").concat(pet.pet.hello),
//                     });
//                 });
//             case 'delete-pet':
...
//                     stateApi === null || stateApi === void 0 ? void 0 : stateApi.postMessage({
//                         command: 'error',
//                         text: "Could not find pet ".concat(message.name),
//                     });
//                 }
//                 break;
//             case 'reset-pet':
